...
4. Курсы требуют подготовки и задают работу, поэтому
    - представьтесь преподавателю и семинаристам, когда задания распределяются по группе,
    - в течение первых недель вам надо понять, сможете ли вы это сдать.
